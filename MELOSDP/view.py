...
from SDP.machine_learning import (
...
def code_test():
    ...
    if file:
        ...
        response = {"code": 200, "message": "File received", "data": code}
...
def suggestion_test():
    ...
    println("修改意见—————————————————")
    print(suggestions)
    response = {"code": 200, "message": "File received", "data": suggestions}
    return jsonify(response)
...
def data_test():
    ...
    response_data = {"code": 400, "message": "Data received successfully", "data": data}
